...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen flex items-center justify-center bg-gray-100 p-4" }, _attrs))}><div class="bg-white rounded-lg shadow-xl p-8 md:p-12 max-w-lg w-full text-center"><div class="text-green-500 mb-6">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "ic:round-check-circle",
        class: "h-24 w-24 mx-auto"
      }, null, _parent));
      _push(`</div><h1 class="text-4xl font-bold text-gray-800 mb-4">Reserva Confirmada!</h1><p class="text-lg text-gray-600 mb-6"> Sua reserva foi realizada com sucesso. Você receberá um e-mail de confirmação em breve com todos os detalhes. </p>`);
...
//# sourceMappingURL=booking-confirmation-C64Xou3l.mjs.map
