import { _ as _sfc_main$1 } from './BaseButton-DzkEl3WK.mjs';
import { _ as __nuxt_component_0 } from './nuxt-link-B9kPwo0C.mjs';
import { u as useFetch } from './fetch-kpGaDUt7.mjs';
import { v as vueExports, a as useRoute, b as useRouter, c as createError } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: response, pending, error } = ([__temp, __restore] = vueExports.withAsyncContext(() => useFetch(`/api/hotels/${hotelId}`, "$3rsRQct2yO")), __temp = await __temp, __restore(), __temp);
    const hotel = vueExports.computed(() => {
      var _a;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (vueExports.unref(pending)) {
        _push(`<div${ssrRenderAttrs(vueExports.mergeProps({ class: "min-h-screen flex items-center justify-center" }, _attrs))}><p class="text-gray-600">Carregando detalhes do hotel...</p></div>`);
      } else if (vueExports.unref(error)) {
        _push(`<div${ssrRenderAttrs(vueExports.mergeProps({ class: "min-h-screen flex items-center justify-center" }, _attrs))}><p class="text-red-500">Erro ao carregar os detalhes do hotel: ${ssrInterpolate(vueExports.unref(error).message)}</p></div>`);
      } else if (hotel.value) {
        _push(`<div${ssrRenderAttrs(vueExports.mergeProps({ class: "container mx-auto p-4 md:p-8" }, _attrs))}><div class="bg-white rounded-lg shadow-lg overflow-hidden"><div class="relative h-64 md:h-96"><img${ssrRenderAttr("src", hotel.value.imageUrl)}${ssrRenderAttr("alt", hotel.value.name)} class="w-full h-full object-cover"><div class="absolute inset-0 bg-black bg-opacity-30 flex items-end p-4 md:p-6"><h1 class="text-white text-3xl md:text-5xl font-bold">${ssrInterpolate(hotel.value.name)}</h1></div></div><div class="p-4 md:p-6 lg:flex lg:space-x-8"><div class="lg:w-2/3"><p class="text-gray-600 mb-4 text-lg">${ssrInterpolate(hotel.value.location)}</p><div class="flex items-center text-yellow-500 mb-4"><!--[-->`);
        ssrRenderList(5, (n) => {
          _push(`<!--[-->`);
          ...
          _push(ssrRenderComponent(_component_BaseButton, {
            ...
            default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                return [
                  hotel.value.availableRooms === 0 ? (vueExports.openBlock(), vueExports.createBlock("span", { key: 0 }, "Esgotado")) : (vueExports.openBlock(), vueExports.createBlock("span", { key: 1 }, "Reservar Agora"))
                ];
              }
            }),
            _: 1
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                return [
                  vueExports.createTextVNode(" Fazer Login ")
                ];
              }
            }),
            _: 1
        ...
        _push(`<div${ssrRenderAttrs(vueExports.mergeProps({ class: "min-h-screen flex items-center justify-center" }, _attrs))}><p class="text-gray-600">Hotel n\xE3o encontrado.</p></div>`);
      }
    };
  }
});
...
//# sourceMappingURL=index-CTjNyZp3.mjs.map
