...
import { v as vueExports, a as useRoute, b as useRouter, u as useHead } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props) {
    ...
    const hotel = vueExports.ref(null);
    ...
    const today = vueExports.ref("");
    const minCheckOutDate = vueExports.computed(() => {
    ...
    vueExports.watch(() => form.value.checkInDate, (newVal) => {
    ...
    vueExports.watch(() => form.value.cardNumber, (newValue) => {
    ...
    vueExports.watch(() => form.value.expiryDate, (newValue) => {
      let cleaned = newValue.replace(/\D/g, "");
      if (cleaned.length > 2) {
    ...
    useHead({
      title: vueExports.computed(() => hotel.value ? `Reservar ${hotel.value.name} - Meu App de Reservas` : "Reservar Hotel")
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(vueExports.mergeProps({ class: "container mx-auto p-4 md:p-8" }, _attrs))} data-v-0f1722bb>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: `/hotels/${vueExports.unref(hotelId)}`,
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              vueExports.createTextVNode(" \u2190 Voltar para os detalhes do hotel ")
            ];
          }
        }),
        _: 1
        ...
        _push(ssrRenderComponent(_component_BaseButton, {
          ...
          default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              return [
                submitting.value ? (vueExports.openBlock(), vueExports.createBlock("span", { key: 0 }, "Enviando...")) : (vueExports.openBlock(), vueExports.createBlock("span", { key: 1 }, "Confirmar Reserva"))
              ];
            }
          }),
          _: 1
...
//# sourceMappingURL=book-Z0YK8rIj.mjs.map
