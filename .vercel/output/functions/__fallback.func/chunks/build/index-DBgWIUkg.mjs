import { _ as _sfc_main$2 } from './BaseInput-BKHxPLRt.mjs';
import { _ as _sfc_main$3 } from './BaseButton-DzkEl3WK.mjs';
...
import { u as useFetch } from './fetch-kpGaDUt7.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props) {
    ...
    const isCompared = vueExports.computed(() => {
          ...
          if (_push2) {
            ...
            return [
              ...
              vueExports.createVNode("div", { class: "p-4" }, [
                vueExports.createVNode("h3", { class: "text-xl font-semibold text-gray-800 mb-2" }, vueExports.toDisplayString(_ctx.hotel.name), 1),
                vueExports.createVNode("p", { class: "text-gray-600 text-sm mb-2" }, vueExports.toDisplayString(_ctx.hotel.location), 1),
                vueExports.createVNode("div", { class: "flex items-center mb-2" }, [
                  vueExports.createVNode("div", { class: "flex text-yellow-500" }, [
                    (vueExports.openBlock(), vueExports.createBlock(vueExports.Fragment, null, vueExports.renderList(5, (n) => {
                      return vueExports.openBlock(), vueExports.createBlock(vueExports.Fragment, { key: n }, [
                        n <= Math.floor(_ctx.hotel.rating) ? (vueExports.openBlock(), vueExports.createBlock(_component_Icon, {
                          key: 0,
                          name: "ic:round-star"
                        })) : n - 0.5 === _ctx.hotel.rating ? (vueExports.openBlock(), vueExports.createBlock(_component_Icon, {
                          key: 1,
                          name: "ic:round-star-half",
                          class: "h-5 w-5"
                        })) : (vueExports.openBlock(), vueExports.createBlock(_component_Icon, {
                          key: 2,
                          name: "ic:round-star-border",
                          class: "h-5 w-5"
                        }))
                  ...
                  vueExports.createVNode("span", { class: "ml-2 text-gray-700 text-sm" }, vueExports.toDisplayString(((_c = _ctx.hotel.rating) == null ? void 0 : _c.toFixed(1)) || "N/A") + " (" + vueExports.toDisplayString(_ctx.hotel.reviewsCount) + " avalia\xE7\xF5es)", 1)
                ]),
                vueExports.createVNode("p", { class: "text-gray-900 text-lg font-bold mb-4" }, "R$ " + vueExports.toDisplayString(((_d = _ctx.hotel.pricePerNight) == null ? void 0 : _d.toFixed(2)) || "0.00") + " / noite", 1),
                vueExports.createVNode("button", {
                  onClick: vueExports.withModifiers(toggleCompare, ["prevent"]),
                  class: [
                    "w-full px-4 py-2 rounded-md text-sm font-medium transition-colors duration-200",
                    isCompared.value ? "bg-red-500 text-white hover:bg-red-600" : "bg-indigo-600 text-white hover:bg-indigo-700"
                  ]
                }, [
                  isCompared.value ? (vueExports.openBlock(), vueExports.createBlock(vueExports.Fragment, { key: 0 }, [
                    vueExports.createVNode(_component_Icon, {
                      name: "ic:round-check",
                      class: "inline-block align-middle mr-1"
                    }),
                    vueExports.createTextVNode(" Na Compara\xE7\xE3o ")
                  ], 64)) : (vueExports.openBlock(), vueExports.createBlock(vueExports.Fragment, { key: 1 }, [
                    vueExports.createVNode(_component_Icon, {
                      name: "ic:round-add",
                      class: "inline-block align-middle mr-1"
                    }),
                    vueExports.createTextVNode(" Adicionar \xE0 Compara\xE7\xE3o ")
                  ], 64))
                ], 2)
              ])
            ];
...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  async setup(__props) {
    ...
    const searchCriteria = vueExports.ref({
      location: "",
      minPrice: null,
      maxPrice: null,
      minRating: null,
    ...
    const { data, pending, error, refresh } = ([__temp, __restore] = vueExports.withAsyncContext(() => useFetch("/api/hotels", {
    ...
    const hotels = vueExports.computed(() => data.value || []);
    vueExports.watch(
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(vueExports.mergeProps({ class: "p-4" }, _attrs))}><h1 class="text-4xl font-bold text-gray-800 mb-6"> Encontre o hotel perfeito! </h1>`);
      if (vueExports.unref(authStore).isAuthenticated) {
        _push(`<p class="text-lg text-gray-700 mb-8"> Bem-vindo de volta, <span class="font-semibold">${ssrInterpolate(((_a = vueExports.unref(authStore).currentUser) == null ? void 0 : _a.name) || "Usu\xE1rio")}</span>! Vamos encontrar sua pr\xF3xima estadia? </p>`);
      } else {
      ...
      _push(ssrRenderComponent(_component_BaseButton, {
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              vueExports.createTextVNode(" Buscar ")
            ];
          }
        }),
        _: 1
      ...
      if (vueExports.unref(pending)) {
        ...
        _push(`<div class="text-center text-red-600 text-lg"> Erro ao carregar hot\xE9is: ${ssrInterpolate(vueExports.unref(error).message || "Verifique sua conex\xE3o.")}</div>`);
...
//# sourceMappingURL=index-DBgWIUkg.mjs.map
