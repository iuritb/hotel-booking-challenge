...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container mx-auto p-4 md:p-8" }, _attrs))}><h1 class="text-4xl font-bold text-gray-800 mb-6">Comparar Hot\xE9is</h1>`);
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              return [
                createTextVNode(" Voltar para a lista de hot\xE9is ")
              ];
            }
          }),
          _: 1
...
//# sourceMappingURL=compare-C6DuQHxN.mjs.map
