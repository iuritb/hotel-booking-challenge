...
import { v as vueExports, b as useRouter } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(vueExports.mergeProps({ class: "min-h-screen flex items-center justify-center bg-gray-100 p-4" }, _attrs))}><div class="max-w-md w-full bg-white rounded-lg shadow-md p-8"><h2 class="text-3xl font-extrabold text-center text-gray-900 mb-6">Fazer Login</h2><form><div class="mb-4">`);
      ...
      _push(ssrRenderComponent(_component_BaseButton, {
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              isLoading.value ? (vueExports.openBlock(), vueExports.createBlock("span", { key: 0 }, "Entrando...")) : (vueExports.openBlock(), vueExports.createBlock("span", { key: 1 }, "Entrar"))
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              vueExports.createTextVNode("Registre-se aqui.")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=login-Csotz6Ul.mjs.map
