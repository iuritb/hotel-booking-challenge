        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span class="font-semibold text-lg"${_scopeId}>${ssrInterpolate(unref(compareStore).getComparisonCount)} Hot\xE9is para Comparar </span>`);
              _push2(ssrRenderComponent(_component_Icon, {
              ...
              return [
                ...
                createVNode("span", { class: "font-semibold text-lg" }, toDisplayString(unref(compareStore).getComparisonCount) + " Hot\xE9is para Comparar ", 1),
                createVNode(_component_Icon, {
                  name: "ic:round-arrow-forward",
                  class: "h-5 w-5 ml-2 transition-transform duration-200 group-hover:translate-x-1"
                })
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createTextVNode(" \u{1F3E8} Hotel Booking ")
            ];
          }
        }),
        _: 1
      ...
      if (unref(authStore).isAuthenticated) {
        _push(`<!--[--><span>Ol\xE1, ${ssrInterpolate(((_a = unref(authStore).currentUser) == null ? void 0 : _a.name) || "Usu\xE1rio")}!</span>`);
...
//# sourceMappingURL=default-BNwnrnd8.mjs.map
