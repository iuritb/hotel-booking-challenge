...
import { c as createError$1, w as withQuery, i as hasProtocol, k as parseURL$1, l as isScriptProtocol, m as joinURL, n as sanitizeStatusCode, $ as $fetch, o as defu, q as createHooks, v as isSamePath, x as toRouteMatcher, y as createRouter$1, z as getContext } from '../_/nitro.mjs';
...
var vue$2 = { exports: {} };
var vue_cjs_prod$2 = {};
var hasRequiredVue_cjs_prod$2;
function requireVue_cjs_prod$2() {
  if (hasRequiredVue_cjs_prod$2) return vue_cjs_prod$2;
  hasRequiredVue_cjs_prod$2 = 1;
  (function(exports$1) {
    /**
    * vue v3.5.24
  ...
  return vue_cjs_prod$2;
}
{
  vue$2.exports = requireVue_cjs_prod$2();
}
var vueExports$2 = vue$2.exports;
if (!globalThis.$fetch) {
...
function createNuxtApp(options) {
  ...
  const nuxtApp = {
    _scope: vueExports$2.effectScope(),
    provide: void 0,
    globalName: "nuxt",
    versions: {
      get nuxt() {
...
const useRoute$1 = () => {
  if (vueExports$2.hasInjectionContext()) {
    return vueExports$2.inject(PageRouteSymbol, (/* @__PURE__ */ useNuxtApp())._route);
  }
...
const useError = () => vueExports$2.toRef((/* @__PURE__ */ useNuxtApp()).payload, "error");
...
function requireVue_cjs_prod$1() {
  if (hasRequiredVue_cjs_prod$1) return vue_cjs_prod$1;
...
vueExports$1.version[0] === "3";
function resolveUnref(r) {
  return typeof r === "function" ? r() : vueExports$1.unref(r);
}
  ...
  if (typeof root === "object") {
    ...
    for (const k in root) {
      ...
      if (k === "titleTemplate" || k[0] === "o" && k[1] === "n") {
        resolved[k] = vueExports$1.unref(root[k]);
        continue;
      }
...
function injectHead() {
  ...
  const head = vueExports$1.inject(headSymbol);
...
function clientUseHead(head, input, options = {}) {
  const deactivated = vueExports$1.ref(false);
  const resolvedInput = vueExports$1.ref({});
  vueExports$1.watchEffect(() => {
    resolvedInput.value = deactivated.value ? {} : resolveUnrefHeadInput(input);
  });
  const entry2 = head.push(resolvedInput.value, options);
  vueExports$1.watch(resolvedInput, (e) => {
    entry2.patch(e);
  });
  vueExports$1.getCurrentInstance();
  return entry2;
}
...
(function(exports$1) {
  ...
  function createSetupStore($id, setup, options = {}, pinia, hot, isOptionsStore) {
    ...
    if (vueDemi2.isVue2) {
      ...
      assign2(vueDemi2.toRaw(store), setupStore);
    }
...
function useLink(props) {
  ...
  const route = vueExports.computed(() => router.resolve(vueExports.unref(props.to)));
  ...
  function navigate(e = {}) {
    if (guardEvent(e)) {
      return router[vueExports.unref(props.replace) ? "replace" : "push"](
...
const _routes = [
  {
    ...
    component: () => import('./booking-confirmation-Cxlv2Mlb.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./compare-DiIwh9jB.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./book-Z0YK8rIj.mjs').then((m) => m.default || m)
  },
  {
    name: "hotels-id",
    path: "/hotels/:id()",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-CTjNyZp3.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-DBgWIUkg.mjs').then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./login-Csotz6Ul.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./register-Bc3gZp7C.mjs').then((m) => m.default || m)
  }
];
const _wrapIf = (component, props, slots) => {
  ...
  return { default: () => {
    var _a;
    return props ? vueExports$2.h(component, props, slots) : (_a = slots.default) == null ? void 0 : _a.call(slots);
  } };
};
...
const plugin$1 = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(nuxtApp) {
    ...
    const previousRoute = vueExports$2.shallowRef(router.currentRoute.value);
    ...
    const _route = vueExports$2.shallowRef(router.currentRoute.value);
    ...
    nuxtApp._route = vueExports$2.shallowReactive(route);
    ...
    router.beforeEach(async (to, from) => {
      ...
      to.meta = vueExports$2.reactive(to.meta);
      if (nuxtApp.isHydrating && initialLayout && !vueExports$2.isReadonly(to.meta.layout)) {
...
vueExports$2.defineComponent({
  name: "ClientOnly",
  inheritAttrs: false,
  // eslint-disable-next-line vue/require-prop-types
  props: ["fallback", "placeholder", "placeholderTag", "fallbackTag"],
  setup(_, { slots, attrs }) {
    const mounted = vueExports$2.ref(false);
    vueExports$2.provide(clientOnlySymbol, true);
    return (props) => {
      var _a;
      if (mounted.value) {
      ...
      return vueExports$2.createElementBlock(fallbackTag, attrs, fallbackStr);
    };
  }
});
...
const reducers = {
  ...
  EmptyShallowRef: (data) => vueExports$2.isRef(data) && vueExports$2.isShallow(data) && !data.value && (typeof data.value === "bigint" ? "0n" : JSON.stringify(data.value) || "_"),
  EmptyRef: (data) => vueExports$2.isRef(data) && !data.value && (typeof data.value === "bigint" ? "0n" : JSON.stringify(data.value) || "_"),
  ShallowRef: (data) => vueExports$2.isRef(data) && vueExports$2.isShallow(data) && data.value,
  ShallowReactive: (data) => vueExports$2.isReactive(data) && vueExports$2.isShallow(data) && vueExports$2.toRaw(data),
  Ref: (data) => vueExports$2.isRef(data) && data.value,
  Reactive: (data) => vueExports$2.isReactive(data) && vueExports$2.toRaw(data)
};
...
const layouts = {
  default: () => import('./default-CJQ42fLe.mjs').then((m) => m.default || m)
};
const LayoutLoader = vueExports$2.defineComponent({
  name: "LayoutLoader",
  inheritAttrs: false,
  props: {
    name: String,
  ...
  async setup(props, context) {
    ...
    return () => vueExports$2.h(LayoutComponent, props.layoutProps, context.slots);
  }
});
const __nuxt_component_0 = vueExports$2.defineComponent({
  name: "NuxtLayout",
  inheritAttrs: false,
  props: {
    name: {
  ...
  setup(props, context) {
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
    const injectedRoute = vueExports$2.inject(PageRouteSymbol);
    const route = injectedRoute === useRoute$1() ? useRoute() : injectedRoute;
    const layout = vueExports$2.computed(() => {
      let layout2 = vueExports$2.unref(props.name) ?? route.meta.layout ?? "default";
      if (layout2 && !(layout2 in layouts)) {
        if (props.fallback) {
          layout2 = vueExports$2.unref(props.fallback);
        }
      }
      return layout2;
    });
    const layoutRef = vueExports$2.ref();
    context.expose({ layoutRef });
    const done = nuxtApp.deferHydration();
    return () => {
      const hasLayout = layout.value && layout.value in layouts;
      const transitionProps = route.meta.layoutTransition ?? appLayoutTransition;
      return _wrapIf(vueExports$2.Transition, hasLayout && transitionProps, {
        default: () => vueExports$2.h(vueExports$2.Suspense, { suspensible: true, onResolve: () => {
          vueExports$2.nextTick(done);
        } }, {
          default: () => vueExports$2.h(
            LayoutProvider,
            {
              layoutProps: vueExports$2.mergeProps(context.attrs, { ref: layoutRef }),
...
const LayoutProvider = vueExports$2.defineComponent({
  ...
  setup(props, context) {
    ...
    if (props.shouldProvide) {
      vueExports$2.provide(LayoutMetaSymbol, {
...
const RouteProvider = vueExports$2.defineComponent({
  props: {
    vnode: {
      type: Object,
      required: true
  ...
  setup(props) {
    ...
    vueExports$2.provide(PageRouteSymbol, vueExports$2.shallowReactive(route));
    return () => {
      return vueExports$2.h(props.vnode, { ref: props.vnodeRef });
    };
  }
});
const __nuxt_component_1 = vueExports$2.defineComponent({
  name: "NuxtPage",
  inheritAttrs: false,
  props: {
    name: {
  ...
  setup(props, { attrs, expose }) {
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
    const pageRef = vueExports$2.ref();
    const forkRoute = vueExports$2.inject(PageRouteSymbol, null);
    let previousPageKey;
    expose({ pageRef });
    vueExports$2.inject(LayoutMetaSymbol, null);
    let vnode;
    const done = nuxtApp.deferHydration();
    if (props.pageKey) {
      vueExports$2.watch(() => props.pageKey, (next, prev) => {
        if (next !== prev) {
    ...
    return () => {
      return vueExports$2.h(RouterView, { name: props.name, route: props.route, ...attrs }, {
        default: (routeProps) => {
          ...
          vnode = _wrapIf(
            vueExports$2.Transition,
            hasTransition && transitionProps,
            wrapInKeepAlive(
              keepaliveConfig,
              vueExports$2.h(vueExports$2.Suspense, {
                suspensible: true,
                onPending: () => nuxtApp.callHook("page:start", routeProps.Component),
                onResolve: () => {
                  vueExports$2.nextTick(() => nuxtApp.callHook("page:finish", routeProps.Component).then(() => nuxtApp.callHook("page:loading:end")).finally(done));
                }
              }, {
                default: () => {
                  const providerVNode = vueExports$2.h(RouteProvider, {
                    key: key || void 0,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vueExports$2.defineAsyncComponent(() => import('./error-404-BvqQOxZY.mjs').then((r) => r.default || r));
    const _Error = vueExports$2.defineAsyncComponent(() => import('./error-500-DLvlO412.mjs').then((r) => r.default || r));
    const ErrorTemplate = is404 ? _Error404 : _Error;
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(vueExports$2.unref(ErrorTemplate), vueExports$2.mergeProps({ statusCode: vueExports$2.unref(statusCode), statusMessage: vueExports$2.unref(statusMessage), description: vueExports$2.unref(description), stack: vueExports$2.unref(stack) }, _attrs), null, _parent));
    };
  }
};
const _sfc_setup$1 = _sfc_main$1.setup;
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = vueExports$2.useSSRContext();
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    vueExports$2.provide(PageRouteSymbol, useRoute$1());
    nuxtApp.hooks.callHookWith((hooks) => hooks.map((hook) => hook()), "vue:setup");
    const error = useError();
    vueExports$2.onErrorCaptured((err, target, info) => {
      nuxtApp.hooks.callHook("vue:error", err, target, info).catch((hookError) => console.error("[nuxt] Error in `vue:error` hook", hookError));
      {
        const p = nuxtApp.runWithContext(() => showError(err));
        vueExports$2.onServerPrefetch(() => p);
        return false;
      }
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderSuspense(_push, {
        default: () => {
          if (vueExports$2.unref(error)) {
            _push(ssrRenderComponent(vueExports$2.unref(_sfc_main$1), { error: vueExports$2.unref(error) }, null, _parent));
          } else if (vueExports$2.unref(islandContext)) {
            _push(ssrRenderComponent(vueExports$2.unref(IslandRenderer), { context: vueExports$2.unref(islandContext) }, null, _parent));
          } else if (vueExports$2.unref(SingleRenderer)) {
            ssrRenderVNode(_push, vueExports$2.createVNode(vueExports$2.resolveDynamicComponent(vueExports$2.unref(SingleRenderer)), null, null), _parent);
          } else {
            _push(ssrRenderComponent(vueExports$2.unref(_sfc_main$2), null, null, _parent));
          }
        },
        _: 1
      });
...
let entry;
{
  entry = async function createNuxtAppServer(ssrContext) {
    const vueApp = vueExports$2.createApp(_sfc_main);
...
export { useRoute as a, useRouter as b, createError as c, useNuxtApp as d, entry_default as default, asyncDataDefaults as e, vueExports$2 as f, fetchDefaults as g, useRouter$1 as h, defineNuxtRouteMiddleware as i, useRuntimeConfig as j, nuxtLinkDefaults as k, navigateTo as n, pinia_prod as p, useHead as u, vueExports as v };
